...
In other words, we may not be able to predict an exact outcome, but we can tell you to a relative degree of certainty what's most likely to occur. In statistics, that's a **confidence interval.**
