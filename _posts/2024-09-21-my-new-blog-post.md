...
<br> *(Remember, we want to find the probability of A **or** B, not A **and** B, because we're not calculating if they will happen at the same time in this case. We're interested in the probability of either occurring separately.)* <br />
...
$$
P(A \text{ or } B) = \frac{30}{90} + \frac{30}{90} - \frac{10}{90} = \text{ 0.555 }
$$
