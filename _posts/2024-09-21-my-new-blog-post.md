...
<br> *(Remember, we want to find the probability of A <u>OR<u /> B, not A <u>AND<u /> B, because we're not calculating if they will happen at the same time in this case. We're interested in the probability of either occuring separately.)* <br />
